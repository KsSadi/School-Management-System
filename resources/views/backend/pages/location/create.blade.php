...
@php
    ...
    $store_route = route('dashboard.location.store');
    $update_route='';
    if(isset($location)){
         $update_route = route('dashboard.location.update', $location->id);
         $data = $location;
    }
    $fetch_route = route('dashboard.location.list');
@endphp
...
>
    ...
    <div>
        ...
        <div class="col-span-12 md:col-span-6">
            <label class="flex flex-col sm:flex-row">Location Image
            </label>
