...
>
    ...
    @if(!isset($role))
        <div class="mt-3" aria-readonly="true">
            <label class="flex flex-col sm:flex-row">Select a Guard ? (required)
                <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-gray-600">Required, at least 2 characters</span>
            </label>
            <select name="guard_name" id="select_guard" class="form-select w-full " readonly="true">
    ...
    @endif
    <div class="mt-3 grid grid-cols-3 gap-y-2">
                ...
                <div class="col-span-3 sm:col-span-1">
                    <label class="flex items-center">
                        <input type="checkbox" name="permissions[]" value="{{$item->id}}"
                               class="input border mr-2" @if(isset($role) && $role->hasPermissionTo($item->name)) checked @endif>
