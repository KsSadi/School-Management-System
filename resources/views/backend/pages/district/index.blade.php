...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            @if( auth('admin')->user() && ( auth('admin')->user()->can('district.create')))
        ...
        <div id="listContainer" class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            @include('backend.pages.district.list')
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 'success') {
                                fetchListData("{{route('dashboard.district.list')}}");
                                Swal.fire(
                                    'Deleted!',
                                    data.message,
                                    'success'
            ...
            $("#addNew").on('click', () => {
                let url = "{{route('dashboard.district.create')}}";
                ajaxGet(url, 'GET', {}, showData);
            });
